...
namespace _20201203
{
    public partial class D10S : Form
    {
        ...
        SerializacionXML<Jugador> logXML = new SerializacionXML<Jugador>();
        ...
        private void btnGolDelSiglo_Click(object sender, EventArgs e)
        {
            ...
            jugador = new Jugador(10, "Diego", "Zurda");
            ...
            logXML.Guardar(RutaDeArchivos.PATHLOGXML, "log.xml", jugador);
        }
